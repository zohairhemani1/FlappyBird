      ...
      if(isBottom==true)
   {
      ...
      console.log("lower");
      nextpipeupper = nextpipe1.children(".pipe_lower");
      // console.log("lower"+nextpipeupper.offset().bottom);
      pipetop = nextpipeupper.offset().top;
      pipeleft =  nextpipeupper.offset().left - 2 ;
      piperight = pipeleft + pipewidth;
      pipebottom = _bottomHeight; 
